...
var options, chart, areachartSalesColors = getChartColorsArray("b2b-sales-forecast-chart"),
    ...
    }, (chart = new ApexCharts(document.querySelector("#b2b-sales-forecast-chart"), options)).render()), getChartColorsArray("deal-type-charts")),
    revenueExpensesChartsColors = (dealTypeChartsColors && (options = {
        ...
        getChartColorsArray("b2b_revenue-expenses-charts"));
...
}, (chart = new ApexCharts(document.querySelector("#b2b_revenue-expenses-charts"), options)).render());
