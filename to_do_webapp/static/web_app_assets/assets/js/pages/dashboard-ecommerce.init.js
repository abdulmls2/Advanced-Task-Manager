function getChartData(){
    ...
    xhr.open('GET', '/amb_staff/get_countries', true);
    xhr.onload = function () {
      if (xhr.readyState === 4 && xhr.status === 200) {
        ...
        return [{name: "Palestine", coords: [31.9474, 35.2272]}, {
          name: "Russia",
...
var options, chart, worldemapmarkers, overlay,
    ...
    vectorMapWorldMarkersColors = (chartDonutBasicColors && (options = {
        series: [44, 55, 41, 17],
        labels: ["Transimission Oil", "Commercial Oil", "Car Oil", "Steering Oil"],
